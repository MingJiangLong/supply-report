...
function initPathData() {
  if (isDev()) {
    location.replace(`http://localhost:5173/supply-report-dev#/take-photo-before-open?vm=99900990&out_trade_no=99902380A20230209163729&loginName=18576518892&is_normal_supply=false`)
  }
